    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1">
          <button onClick={onRefresh} className="w-5 h-5 rounded-full bg-blue-200 hover:bg-blue-300 text-[10px]" title="刷新">
            ?
          </button>
          <button
      ...
      {!isMinimized && (
        ...
        >
          <ul className="space-y-2">
            ...
            {lines.length === 0 && <li className="text-xs text-gray-400 text-center">暂无日程</li>}
          </ul>
        </div>
      )}
    </motion.div>
