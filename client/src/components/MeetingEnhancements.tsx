    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
          ...
          <h2 className="text-2xl font-bold">{t('创建会议')}</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="permanent">{t('永久有效')}</option>

                <option value="24h">{t('24小时内有效')}</option>

                <option value="once">{t('单次有效')}</option>
            ...
            <div>
              ...
              >
                ...
                <option value="invited">{t('仅受邀者')}</option>

                <option value="approval">{t('需要审核')}</option>

                <option value="public">{t('公开可加入')}</option>
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">{t('留空则立即开始会议')}</p>
          ...
          {invitedUsers.length > 0 && (
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-800">
                ...
                {t('meeting.invite.selected', { count: invitedUsers.length })}
