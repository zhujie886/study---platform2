...
const FRAMES = [
    { id: 'default', name: '无边框', color: '#9ca3af' },
    { id: 'thorn', name: '荆棘帝王', color: '#ef4444' },
    { id: 'ocean', name: '海洋海王', color: '#0ea5e9' },
    { id: 'emperor', name: '至尊皇帝', color: '#fbbf24' },
];
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/40 backdrop-blur-sm animate-in fade-in zoom-in-95 duration-200" onClick={onClose}>
            <div className="bg-white w-[360px] rounded-3xl overflow-hidden shadow-2xl" onClick={e => e.stopPropagation()}>
                <div className="h-24 bg-gradient-to-br from-indigo-500 to-purple-600 p-6 relative">
                    <h2 className="text-white text-xl font-bold">装扮中心</h2>
                    <p className="text-white/80 text-xs mt-1">定制你的专属助手风格</p>
                ...
                <div className="p-6 space-y-6">
                    {/* 边框选择 */}
                    <div>
                        <h3 className="text-xs font-bold text-gray-400 uppercase mb-3">头像边框</h3>
                    ...
                    {/* 宠物选择 */}
                    <div>
                        <h3 className="text-xs font-bold text-gray-400 uppercase mb-3">选择伴宠</h3>
                        <div className="grid grid-cols-4 gap-2">
                            {PETS.map(p => (
                                ...
                                >
                                    ...
                                    <span className="text-[10px] text-gray-500 font-bold">{p.name}</span>
                                </button>
                            ))}
                        </div>
                    </div>
